...
class RefreshMiddleware extends BaseMiddleware
{
    /**
     * @Notes :
     *
    ...
    public function handle(Request $request, Closure $next) {
        ...
        if (empty($payload['guard']) || $payload['guard'] != $defaultDriver) {
        ...
        try {
            ...
            try {
                ...
                // 使用一次性登录以保证此次请求的成功
                Auth::onceUsingId($this->auth->manager()->getPayloadFactory()->buildClaimsCollection()->toArray()['sub']);
